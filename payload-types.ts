...
export interface Page {
  ...
  blocks?:
    ...
    | null;
  /**
   * Structured data for search engines and social platforms.
   */
  schemaMarkup?:
    | {
        [k: string]: unknown;
...
export interface PricingTableBlock {
  ...
  plans?:
    | {
        name: string;
        /**
         * Price to display (e.g., "$29/mo", "Free", "Custom")
         */
        price: string;
        description?: string | null;
        /**
...
export interface StatsBlock {
  ...
  items?:
    | {
        /**
         * The number or value to display (e.g., "100k+", "99.9%", "$2M")
         */
        value: string;
        /**
         * Description of the value (e.g., "Active users", "Uptime")
         */
        label: string;
        /**
