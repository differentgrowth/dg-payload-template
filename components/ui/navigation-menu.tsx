...
function NavigationMenuArrow({
  ...
  return (
    <NavigationMenuPrimitive.Arrow
      className={cn(
        "flex transition-[left] duration-(--duration) ease-(--easing) data-[side=bottom]:-top-2 data-[side=left]:-right-3.25 data-[side=top]:-bottom-2 data-[side=right]:-left-3.25 data-[side=left]:rotate-90 data-[side=right]:-rotate-90 data-[side=top]:rotate-180",
        className
      )}
