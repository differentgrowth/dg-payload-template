...
export async function GET(
  ...
  // Require path and either (collection + slug) or global
  const hasCollectionParams = collection && slug;
  const hasGlobalParams = global;

  if (!(path && (hasCollectionParams || hasGlobalParams))) {
