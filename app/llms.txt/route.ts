...
export async function GET() {
  const content = `
    ...
    > ACME es una agencia de desarrollo web que ofrece soluciones digitales para potenciar negocios. Nos especializamos en diseño web a medida, SEO y estrategias de marketing digital para ayudar a pequeñas y medianas empresas a alcanzar su máximo potencial online.
